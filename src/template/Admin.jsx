                            ...
                            <Sider width={230} collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
                                ...
                                <Menu theme="dark" mode="inline">
                                    ...
                                    <SubMenu key="sub2" icon={<AppstoreOutlined />} title="Quản Lý Sản Phẩm">
                                        ...
                                        <Menu.Item key="7"><Link to={`${this.props.match.url}/quanlyloaisanpham`}>Loại Sản Phẩm</Link></Menu.Item>
                                    </SubMenu>
                                    <SubMenu key="sub3" icon={<AppstoreOutlined />} title="Quản lý đơn hàng">
                                        <Menu.Item key="8"><Link to={`${this.props.match.url}/quanlyhoadon`}>Tình trạng thanh toán</Link></Menu.Item>
                                        <Menu.Item key="9"><Link to={`${this.props.match.url}/quanlygiaohang`}>Tình trạng giao hàng</Link></Menu.Item>
                                    </SubMenu>
                                    ...
                                    <Menu.Item key="10" icon={<LogoutOutlined />} onClick={this.adminLogOut}>Đăng Xuất</Menu.Item>
                                </Menu>
                            </Sider>
                                ...
                                <Content style={{ margin: '0 16px' }}>
                                    ...
                                    <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                                      ...
                                      <Switch>
                                        ...
                                        <Route path={`${this.props.match.url}/quanlygiaohang`} component={QuanLyGiaoHang}></Route>
